...
export const globalSlice = createSlice({
  ...
  reducers: {
    ...
    openChapterModal: (
      ...
      state.courseEditor.isChapterModalOpen =
        true;
    ...
    openSectionModal: (
      ...
      state.courseEditor.isSectionModalOpen =
        true;
      state.courseEditor.selectedSectionIndex =
        action.payload.sectionIndex;
    },
    ...
    addSection: (
      ...
      state.courseEditor.sections.push(
        action.payload
      );
    },
    editSection: (
    ...
    deleteSection: (
      ...
      state.courseEditor.sections.splice(
        action.payload,
        1
      );
    },
    ...
    editChapter: (
      ...
      state.courseEditor.sections[
        action.payload.sectionIndex
      ].chapters[action.payload.chapterIndex] =
