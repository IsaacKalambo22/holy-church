                ...
                >
                  ...
                  section.subMenuItems ? (
                    ...
                    >
                      <NavigationMenuLink
                        className={cn(
                          'text-gray-800 hover:text-primary mr-5',
                          pathname ===
                            section.href &&
                            'text-primary'
                        )}
      ...
      <li>
        <NavigationMenuLink asChild>
          <a
            ref={ref}
            className={cn(
              ' select-none space-y-1 rounded-lg p-3 leading-none no-underline outline-none transition-colors hover:bg-accent hover:text-gray-900 focus:bg-accent focus:text-gray-900 text-gray-900 flex items-center gap-4',
              className
            )}
            {...props}
          >
